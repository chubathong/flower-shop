...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link">Edit Product</a>
      </li>
    </ul>
 ...
 <s:form method="post" modelAttribute="product"
		action="${pageContext.request.contextPath }/product/edit">
                  ...
                  <div class="form-group">
                    ...
                    <s:input path="name" class="form-control" id="exampleInputEmail1" placeholder="Enter email"/>
                    
                  </div>
                                    <div class="form-group">
                    <label for="exampleInputEmail1">Price</label>
                    <s:input path="price" class="form-control" id="exampleInputEmail1" placeholder="Enter email"/>
                    
                  </div>
                                    <div class="form-group">
                    <label for="exampleInputEmail1">Quantity</label>
                    <s:input path="quantity" class="form-control" id="exampleInputEmail1" placeholder="Enter email"/>
                    ...
                    <s:input path="description" class="form-control" id="exampleInputEmail1" placeholder="Enter email"/>
                    
                  </div>
                                    <div class="form-group">
                    <label for="exampleInputEmail1">Photo</label>
                    <s:input path="photo" class="form-control" id="exampleInputEmail1" placeholder="Enter email"/>
